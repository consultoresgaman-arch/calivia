...
const SYSTEM_PROMPT: Record<Lang, string> = {
  ...
  en: [
    ...
    '',
    'REFERRAL: if they ask for professional help or you notice it is time for a deeper step, naturally share: https://calendly.com/consultoresgaman/30min',
  ].join('\n'),
  pt: [
    ...
    'calma.',
    '',
    'ENCAMINHAMENTO: se pedir ajuda profissional ou você notar que é hora de dar um passo mais profundo, compartilhe com naturalidade: https://calendly.com/consultoresgaman/30min',
  ].join('\n'),
};
